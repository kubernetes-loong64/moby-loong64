...
Push a branch named `loong64-<moby-version>` (e.g. `loong64-docker-v29.8.0`) to trigger a build. Append `+<build>`
(e.g. `loong64-docker-v29.8.0+0`) to include build metadata.

## [Release](https://github.com/kubernetes-loong64/moby-loong64/releases)

Push a tag matching `release-loong64-<moby-version>` (e.g. `release-loong64-docker-v29.8.0+0`) to publish
